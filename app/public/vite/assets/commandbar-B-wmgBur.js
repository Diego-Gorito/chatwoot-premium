import{c as A,r as qe,a5 as hi,L as di,n as ui,o as pi}from"./_plugin-vue_export-helper-9CYU8a8C.js";import{N as vi,u as Q,e as j,d as k,c as St}from"./useBranding-goIl-Xz0.js";import{a as fi}from"./index-B52QOzZ4.js";import{L as _i,u as Et,w as L,a as Ai}from"./Validators-CJURFA16.js";import{L as gi,m as Oi,y as mi,bd as Ni}from"./DashboardIcon-BSTpDZpJ.js";import{B as Ci,E as wt,F as Mi,G as Si,H as R,I as Ei,J as wi,K as Ti,M as yi,N as Ii,O as Ri,P as bi,Q as $i,R as xi,S as Li,T as ji,U as ki,V as Di,W as Qe}from"./dashboard-D77UBLge.js";import"./utils.esm-D4GRaCqZ.js";import"./index-DN3rM4CW.js";import"./_commonjsHelpers-BosuxZz1.js";import"./js.cookie-Cz0CWeBA.js";import"./index-CYzgwgNG.js";import"./Icon-CMbvOJO8.js";import"./index-5JTLAUge.js";import"./typing-DpamI52y.js";import"./vue-dompurify-html-B9EYdvnm.js";import"./useKeyboardNavigableList-PzY-NWQg.js";import"./helper-BVTgYTlr.js";import"./module-BJBVCK_u.js";import"./BarChart-G2jryyk6.js";import"./constants-lVAyZKq6.js";import"./IframeLoader-_Gq7FjQK.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var we;const _e=window,X=_e.trustedTypes,ot=X?X.createPolicy("lit-html",{createHTML:t=>t}):void 0,Ze="$lit$",D=`lit$${(Math.random()+"").slice(9)}$`,It="?"+D,Zi=`<${It}>`,G=document,ae=()=>G.createComment(""),le=t=>t===null||typeof t!="object"&&typeof t!="function",Rt=Array.isArray,Vi=t=>Rt(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",Te=`[ 	
\f\r]`,te=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,st=/-->/g,at=/>/g,Z=RegExp(`>|${Te}(?:([^\\s"'>=/]+)(${Te}*=${Te}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),lt=/'/g,rt=/"/g,bt=/^(?:script|style|textarea|title)$/i,Ui=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),T=Ui(1),b=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),ct=new WeakMap,U=G.createTreeWalker(G,129,null,!1);function $t(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return ot!==void 0?ot.createHTML(e):e}const Gi=(t,e)=>{const i=t.length-1,n=[];let o,s=e===2?"<svg>":"",a=te;for(let l=0;l<i;l++){const r=t[l];let c,h,u=-1,d=0;for(;d<r.length&&(a.lastIndex=d,h=a.exec(r),h!==null);)d=a.lastIndex,a===te?h[1]==="!--"?a=st:h[1]!==void 0?a=at:h[2]!==void 0?(bt.test(h[2])&&(o=RegExp("</"+h[2],"g")),a=Z):h[3]!==void 0&&(a=Z):a===Z?h[0]===">"?(a=o??te,u=-1):h[1]===void 0?u=-2:(u=a.lastIndex-h[2].length,c=h[1],a=h[3]===void 0?Z:h[3]==='"'?rt:lt):a===rt||a===lt?a=Z:a===st||a===at?a=te:(a=Z,o=void 0);const p=a===Z&&t[l+1].startsWith("/>")?" ":"";s+=a===te?r+Zi:u>=0?(n.push(c),r.slice(0,u)+Ze+r.slice(u)+D+p):r+D+(u===-2?(n.push(void 0),l):p)}return[$t(t,s+(t[i]||"<?>")+(e===2?"</svg>":"")),n]};class re{constructor({strings:e,_$litType$:i},n){let o;this.parts=[];let s=0,a=0;const l=e.length-1,r=this.parts,[c,h]=Gi(e,i);if(this.el=re.createElement(c,n),U.currentNode=this.el.content,i===2){const u=this.el.content,d=u.firstChild;d.remove(),u.append(...d.childNodes)}for(;(o=U.nextNode())!==null&&r.length<l;){if(o.nodeType===1){if(o.hasAttributes()){const u=[];for(const d of o.getAttributeNames())if(d.endsWith(Ze)||d.startsWith(D)){const p=h[a++];if(u.push(d),p!==void 0){const v=o.getAttribute(p.toLowerCase()+Ze).split(D),g=/([.?@])?(.*)/.exec(p);r.push({type:1,index:s,name:g[2],strings:v,ctor:g[1]==="."?Ki:g[1]==="?"?Yi:g[1]==="@"?Wi:Oe})}else r.push({type:6,index:s})}for(const d of u)o.removeAttribute(d)}if(bt.test(o.tagName)){const u=o.textContent.split(D),d=u.length-1;if(d>0){o.textContent=X?X.emptyScript:"";for(let p=0;p<d;p++)o.append(u[p],ae()),U.nextNode(),r.push({type:2,index:++s});o.append(u[d],ae())}}}else if(o.nodeType===8)if(o.data===It)r.push({type:2,index:s});else{let u=-1;for(;(u=o.data.indexOf(D,u+1))!==-1;)r.push({type:7,index:s}),u+=D.length-1}s++}}static createElement(e,i){const n=G.createElement("template");return n.innerHTML=e,n}}function J(t,e,i=t,n){var o,s,a,l;if(e===b)return e;let r=n!==void 0?(o=i._$Co)===null||o===void 0?void 0:o[n]:i._$Cl;const c=le(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==c&&((s=r==null?void 0:r._$AO)===null||s===void 0||s.call(r,!1),c===void 0?r=void 0:(r=new c(t),r._$AT(t,i,n)),n!==void 0?((a=(l=i)._$Co)!==null&&a!==void 0?a:l._$Co=[])[n]=r:i._$Cl=r),r!==void 0&&(e=J(t,r._$AS(t,e.values),r,n)),e}class zi{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var i;const{el:{content:n},parts:o}=this._$AD,s=((i=e==null?void 0:e.creationScope)!==null&&i!==void 0?i:G).importNode(n,!0);U.currentNode=s;let a=U.nextNode(),l=0,r=0,c=o[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new ee(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new Xi(a,this,e)),this._$AV.push(h),c=o[++r]}l!==(c==null?void 0:c.index)&&(a=U.nextNode(),l++)}return U.currentNode=G,s}v(e){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,i),i+=n.strings.length-2):n._$AI(e[i])),i++}}class ee{constructor(e,i,n,o){var s;this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=n,this.options=o,this._$Cp=(s=o==null?void 0:o.isConnected)===null||s===void 0||s}get _$AU(){var e,i;return(i=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&i!==void 0?i:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=J(this,e,i),le(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==b&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Vi(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==m&&le(this._$AH)?this._$AA.nextSibling.data=e:this.$(G.createTextNode(e)),this._$AH=e}g(e){var i;const{values:n,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=re.createElement($t(o.h,o.h[0]),this.options)),o);if(((i=this._$AH)===null||i===void 0?void 0:i._$AD)===s)this._$AH.v(n);else{const a=new zi(s,this),l=a.u(this.options);a.v(n),this.$(l),this._$AH=a}}_$AC(e){let i=ct.get(e.strings);return i===void 0&&ct.set(e.strings,i=new re(e)),i}T(e){Rt(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,o=0;for(const s of e)o===i.length?i.push(n=new ee(this.k(ae()),this.k(ae()),this,this.options)):n=i[o],n._$AI(s),o++;o<i.length&&(this._$AR(n&&n._$AB.nextSibling,o),i.length=o)}_$AR(e=this._$AA.nextSibling,i){var n;for((n=this._$AP)===null||n===void 0||n.call(this,!1,!0,i);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var i;this._$AM===void 0&&(this._$Cp=e,(i=this._$AP)===null||i===void 0||i.call(this,e))}}let Oe=class{constructor(e,i,n,o,s){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=i,this._$AM=o,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=m}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,i=this,n,o){const s=this.strings;let a=!1;if(s===void 0)e=J(this,e,i,0),a=!le(e)||e!==this._$AH&&e!==b,a&&(this._$AH=e);else{const l=e;let r,c;for(e=s[0],r=0;r<s.length-1;r++)c=J(this,l[n+r],i,r),c===b&&(c=this._$AH[r]),a||(a=!le(c)||c!==this._$AH[r]),c===m?e=m:e!==m&&(e+=(c??"")+s[r+1]),this._$AH[r]=c}a&&!o&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}};class Ki extends Oe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}const Fi=X?X.emptyScript:"";class Yi extends Oe{constructor(){super(...arguments),this.type=4}j(e){e&&e!==m?this.element.setAttribute(this.name,Fi):this.element.removeAttribute(this.name)}}class Wi extends Oe{constructor(e,i,n,o,s){super(e,i,n,o,s),this.type=5}_$AI(e,i=this){var n;if((e=(n=J(this,e,i,0))!==null&&n!==void 0?n:m)===b)return;const o=this._$AH,s=e===m&&o!==m||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==m&&(o===m||s);s&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i,n;typeof this._$AH=="function"?this._$AH.call((n=(i=this.options)===null||i===void 0?void 0:i.host)!==null&&n!==void 0?n:this.element,e):this._$AH.handleEvent(e)}}class Xi{constructor(e,i,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){J(this,e)}}const Ji={I:ee},ht=_e.litHtmlPolyfillSupport;ht==null||ht(re,ee),((we=_e.litHtmlVersions)!==null&&we!==void 0?we:_e.litHtmlVersions=[]).push("2.8.0");const qi=(t,e,i)=>{var n,o;const s=(n=i==null?void 0:i.renderBefore)!==null&&n!==void 0?n:e;let a=s._$litPart$;if(a===void 0){const l=(o=i==null?void 0:i.renderBefore)!==null&&o!==void 0?o:null;s._$litPart$=a=new ee(e.insertBefore(ae(),l),l,void 0,i??{})}return a._$AI(t),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ye,Ie;let B=class extends W{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,i;const n=super.createRenderRoot();return(e=(i=this.renderOptions).renderBefore)!==null&&e!==void 0||(i.renderBefore=n.firstChild),n}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=qi(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return b}};B.finalized=!0,B._$litElement$=!0,(ye=globalThis.litElementHydrateSupport)===null||ye===void 0||ye.call(globalThis,{LitElement:B});const dt=globalThis.litElementPolyfillSupport;dt==null||dt({LitElement:B});((Ie=globalThis.litElementVersions)!==null&&Ie!==void 0?Ie:globalThis.litElementVersions=[]).push("3.3.3");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:tn}=Ji,xt=t=>t.strings===void 0,ut=()=>document.createComment(""),ie=(t,e,i)=>{var n;const o=t._$AA.parentNode,s=e===void 0?t._$AB:e._$AA;if(i===void 0){const a=o.insertBefore(ut(),s),l=o.insertBefore(ut(),s);i=new tn(a,l,t,t.options)}else{const a=i._$AB.nextSibling,l=i._$AM,r=l!==t;if(r){let c;(n=i._$AQ)===null||n===void 0||n.call(i,t),i._$AM=t,i._$AP!==void 0&&(c=t._$AU)!==l._$AU&&i._$AP(c)}if(a!==s||r){let c=i._$AA;for(;c!==a;){const h=c.nextSibling;o.insertBefore(c,s),c=h}}}return i},V=(t,e,i=t)=>(t._$AI(e,i),t),nn={},Lt=(t,e=nn)=>t._$AH=e,on=t=>t._$AH,be=t=>{var e;(e=t._$AP)===null||e===void 0||e.call(t,!1,!0);let i=t._$AA;const n=t._$AB.nextSibling;for(;i!==n;){const o=i.nextSibling;i.remove(),i=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pt=(t,e,i)=>{const n=new Map;for(let o=e;o<=i;o++)n.set(t[o],o);return n},sn=he(class extends de{constructor(t){if(super(t),t.type!==x.CHILD)throw Error("repeat() can only be used in text expressions")}ct(t,e,i){let n;i===void 0?i=e:e!==void 0&&(n=e);const o=[],s=[];let a=0;for(const l of t)o[a]=n?n(l,a):a,s[a]=i(l,a),a++;return{values:s,keys:o}}render(t,e,i){return this.ct(t,e,i).values}update(t,[e,i,n]){var o;const s=on(t),{values:a,keys:l}=this.ct(e,i,n);if(!Array.isArray(s))return this.ut=l,a;const r=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],c=[];let h,u,d=0,p=s.length-1,v=0,g=a.length-1;for(;d<=p&&v<=g;)if(s[d]===null)d++;else if(s[p]===null)p--;else if(r[d]===l[v])c[v]=V(s[d],a[v]),d++,v++;else if(r[p]===l[g])c[g]=V(s[p],a[g]),p--,g--;else if(r[d]===l[g])c[g]=V(s[d],a[g]),ie(t,c[g+1],s[d]),d++,g--;else if(r[p]===l[v])c[v]=V(s[p],a[v]),ie(t,s[d],s[p]),p--,v++;else if(h===void 0&&(h=pt(l,v,g),u=pt(r,d,p)),h.has(r[d]))if(h.has(r[p])){const y=u.get(l[v]),P=y!==void 0?s[y]:null;if(P===null){const F=ie(t,s[d]);V(F,a[v]),c[v]=F}else c[v]=V(P,a[v]),ie(t,s[d],P),s[y]=null;v++}else be(s[p]),p--;else be(s[d]),d++;for(;v<=g;){const y=ie(t,c[g+1]);V(y,a[v]),c[v++]=y}for(;d<=p;){const y=s[d++];y!==null&&be(y)}return this.ut=l,Lt(t,c),b}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const an=he(class extends de{constructor(t){if(super(t),t.type!==x.PROPERTY&&t.type!==x.ATTRIBUTE&&t.type!==x.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!xt(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===b||e===m)return e;const i=t.element,n=t.name;if(t.type===x.PROPERTY){if(e===i[n])return b}else if(t.type===x.BOOLEAN_ATTRIBUTE){if(!!e===i.hasAttribute(n))return b}else if(t.type===x.ATTRIBUTE&&i.getAttribute(n)===e+"")return b;return Lt(t),e}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oe=(t,e)=>{var i,n;const o=t._$AN;if(o===void 0)return!1;for(const s of o)(n=(i=s)._$AO)===null||n===void 0||n.call(i,e,!1),oe(s,e);return!0},Ae=t=>{let e,i;do{if((e=t._$AM)===void 0)break;i=e._$AN,i.delete(t),t=e}while((i==null?void 0:i.size)===0)},jt=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(i===void 0)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),cn(e)}};function ln(t){this._$AN!==void 0?(Ae(this),this._$AM=t,jt(this)):this._$AM=t}function rn(t,e=!1,i=0){const n=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(e)if(Array.isArray(n))for(let s=i;s<n.length;s++)oe(n[s],!1),Ae(n[s]);else n!=null&&(oe(n,!1),Ae(n));else oe(this,t)}const cn=t=>{var e,i,n,o;t.type==x.CHILD&&((e=(n=t)._$AP)!==null&&e!==void 0||(n._$AP=rn),(i=(o=t)._$AQ)!==null&&i!==void 0||(o._$AQ=ln))};class hn extends de{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,i,n){super._$AT(e,i,n),jt(this),this.isConnected=e._$AU}_$AO(e,i=!0){var n,o;e!==this.isConnected&&(this.isConnected=e,e?(n=this.reconnected)===null||n===void 0||n.call(this):(o=this.disconnected)===null||o===void 0||o.call(this)),i&&(oe(this,e),Ae(this))}setValue(e){if(xt(this._$Ct))this._$Ct._$AI(e,this);else{const i=[...this._$Ct._$AH];i[this._$Ci]=e,this._$Ct._$AI(i,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ue extends de{constructor(e){if(super(e),this.et=m,e.type!==x.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===m||e==null)return this.ft=void 0,this.et=e;if(e===b)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const i=[e];return i.raw=i,this.ft={_$litType$:this.constructor.resultType,strings:i,values:[]}}}Ue.directiveName="unsafeHTML",Ue.resultType=1;const Nn=he(Ue);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
